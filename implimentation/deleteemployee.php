...
<h2 align="center">WDU-ZPIMS </h2><img src="images/04.jpg" width="230" height="380" align='left'>
...
$delete1="SELECT employeeid FROM employee";
...
{
$empid=$_POST['eid'];
$delete2="SELECT * from employee where employeeid='$empid' ";
$result=mysqli_query($conn,$delete2);
...
<?php
	...
	{
$dele="DELETE FROM employee WHERE employeeid='$empid' ";

$del=mysqli_query($conn,$dele);
if(!$del)
		{
